# Анализ письма email_001 с промптом unified_contact_extraction.txt
...
## Результат анализа с промптом unified
...
```json
{
  ...
  "business_context": "Запрос о сроках отгрузки товара по счету № 8164 от 16 июля 2025 г. Центр Лабораторной Диагностики из Новосибирска обращается к ДНК-Технология с вопросом о сроках поставки уже оплаченного заказа.",
  "summary": {
    "topic": "Доставка и логистика",
    "product_interest": "Лабораторное оборудование (заказ по счету № 8164)",
    "communication_stage": "Исполнение",
    "request_type": "Условия поставки"
  },
  "key_points": [
    "Запрос сроков отгрузки по счету № 8164 от 16 июля 2025 г.",
    "Важность понимания сроков поставки для планирования",
    "Контактное лицо: Бабиченко Иван Сергеевич, Руководитель ОМТС",
    "График работы организации: Пн-Пт 9:00-16:00, обед 12:00-13:00",
    "Адрес: 630075, г. Новосибирск, ул. Народная, 3"
  ],
  "commercial_offers": []
}
