...
class LLMResponseValidator:
    ...
    def __init__(self):
        ...
        print("✅ LLMResponseValidator инициализирован с детальными JSON Schema")
    ...
    def _create_contact_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "phone": {
                    "type": ["string", "null"],
                    "description": "Оригинальный телефон из LLM (не модифицировать!)"
                },
                "raw_phone": {
                    "type": ["string", "null"],
